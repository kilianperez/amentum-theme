                    ...
                    <div class="slide-content">
                        <div class="slide-inner">
                            ...
                            <?php if (!empty($primer_evento_enlace)): ?>
                                <a href="<?php echo esc_url($primer_evento_enlace); ?>" class="btn btn--black"><?php echo $descripcion_inicial; ?></a>
                            <?php else: ?>
                        ...
                        <div class="swiper-slide slide-evento" data-evento-id="<?php echo esc_attr($evento['id']); ?>">
                            ...
                            <div class="slide-content">
                                <div class="slide-inner">
                                    ...
                                    <a href="<?php echo esc_url($evento['enlace']); ?>" class="btn btn--black">Ver evento</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
